...
You can also double-click `AutoCRM.app`. If AutoCRM is not installed yet, it opens Terminal and starts the installer. If AutoCRM is already installed, double-clicking exits without changing anything.
